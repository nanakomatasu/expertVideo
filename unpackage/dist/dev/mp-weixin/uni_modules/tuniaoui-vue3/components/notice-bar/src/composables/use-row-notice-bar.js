...
const useRowNoticeBar = () => {
  ...
  const data = common_vendor.computed(() => {
    var _a;
    if (!((_a = noticeBar == null ? void 0 : noticeBar.data) == null ? void 0 : _a.length))
      return "";
    return noticeBar.data.join(" ");
  });
  const speed = common_vendor.computed(
    () => uni_modules_tuniaouiVue3_utils_isEmpty.isEmptyVariableInDefault(noticeBar == null ? void 0 : noticeBar.speed, 80)
  );
